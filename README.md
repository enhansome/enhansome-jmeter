...
* [GitHub Repository](https://github.com/apache/jmeter) ⭐ 9,506 | 🐛 963 | 🌐 Java | 📅 2026-07-20 - Apache JMeter source code repository.
...
* [jmeter-as-code](https://github.com/anasoid/jmeter-as-code) ⭐ 39 | 🐛 18 | 🌐 Java | 📅 2026-08-14 - Simple wrapper for JMeter to write and execute JMeter tests with Java.
...
* [MeterSphere](https://github.com/metersphere/metersphere) ⭐ 13,440 | 🐛 1 | 🌐 Java | 📅 2026-08-10 - One-stop open-source enterprise-class continuous testing platform, compatible with open-source standards such as JMeter :cn:.
...
* InfluxDB & Grafana
  * [InfluxDB Community Template for JMeter](https://github.com/influxdata/community-templates/tree/master/apache_jmeter) ⭐ 371 | 🐛 76 | 🌐 Python | 📅 2023-06-15 - Prepackaged InfluxDB configurations that contain everything from dashboards and Telegraf configurations to notifications and alerts in a single manifest file.
...
* ELK Stack
  * [jmeter-logstash](https://github.com/anasoid/jmeter-logstash) ⭐ 7 | 🐛 6 | 🌐 Shell | 📅 2026-08-12 - Parse JTL result with Docker and Logstash in real time or after test end, and send data to Elasticsearch or InfluxDB, to have a nice dashboard and compare different tests.
...
* Backend Listener Implementations
  ...
  * [perfana-jmeter-timescaledb](https://github.com/perfana/perfana-jmeter-timescaledb) ⭐ 1 | 🐛 0 | 🌐 Java | 📅 2026-07-21 - JMeter backend listener plugin that writes test results directly to TimescaleDB for real-time performance analysis.
...
* [HLS JMeter Plugin](https://github.com/Blazemeter/HLSPlugin) ⭐ 51 | 🐛 15 | 🌐 Java | 📅 2026-07-14
...
* [Awesome Testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,342 | 🐛 9 | 📅 2026-08-06 - A curated list of testing resources.
