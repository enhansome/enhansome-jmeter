...
* [GitHub Repository](https://github.com/apache/jmeter) ⭐ 9,533 | 🐛 976 | 🌐 Java | 📅 2026-09-12 - Apache JMeter source code repository.
...
* [MeterSphere](https://github.com/metersphere/metersphere) ⭐ 13,525 | 🐛 2 | 🌐 Java | 📅 2026-09-01 - One-stop open-source enterprise-class continuous testing platform, compatible with open-source standards such as JMeter :cn:.
...
* Backend Listener Implementations
  ...
  * [perfana-jmeter-timescaledb](https://github.com/perfana/perfana-jmeter-timescaledb) ⭐ 1 | 🐛 0 | 🌐 Java | 📅 2026-09-15 - JMeter backend listener plugin that writes test results directly to TimescaleDB for real-time performance analysis.
...
* [HLS JMeter Plugin](https://github.com/Blazemeter/HLSPlugin) ⭐ 52 | 🐛 15 | 🌐 Java | 📅 2026-09-14
