...
* [GitHub Repository](https://github.com/apache/jmeter) ⭐ 9,534 | 🐛 976 | 🌐 Java | 📅 2026-09-12 - Apache JMeter source code repository.
...
* [MeterSphere](https://github.com/metersphere/metersphere) ⭐ 13,530 | 🐛 1 | 🌐 Java | 📅 2026-09-01 - One-stop open-source enterprise-class continuous testing platform, compatible with open-source standards such as JMeter :cn:.
...
* InfluxDB & Grafana
  * [InfluxDB Community Template for JMeter](https://github.com/influxdata/community-templates/tree/master/apache_jmeter) ⭐ 376 | 🐛 76 | 🌐 Python | 📅 2023-06-15 - Prepackaged InfluxDB configurations that contain everything from dashboards and Telegraf configurations to notifications and alerts in a single manifest file.
...
* Backend Listener Implementations
  ...
  * [jmeter-datadog-backend-listener](https://github.com/DataDog/jmeter-datadog-backend-listener) ⭐ 13 | 🐛 9 | 🌐 Java | 📅 2026-09-16 - Send JMeter test results to Datadog.
