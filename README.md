...
* [GitHub Repository](https://github.com/apache/jmeter) ⭐ 9,523 | 🐛 978 | 🌐 Java | 📅 2026-08-27 - Apache JMeter source code repository.
...
* [jmeter-as-code](https://github.com/anasoid/jmeter-as-code) ⭐ 39 | 🐛 17 | 🌐 Java | 📅 2026-08-28 - Simple wrapper for JMeter to write and execute JMeter tests with Java.
...
* [MeterSphere](https://github.com/metersphere/metersphere) ⭐ 13,497 | 🐛 2 | 🌐 Java | 📅 2026-09-01 - One-stop open-source enterprise-class continuous testing platform, compatible with open-source standards such as JMeter :cn:.
...
* [JMeter Load Testing Center](https://github.com/innogames/ltc) ⭐ 203 | 🐛 15 | 🌐 Python | 📅 2026-09-01 - Online web-application/dashboard to run, monitor and analyze results of load tests using JMeter.
...
* [postman2jmx](https://github.com/Loadium/postman2jmx) ⭐ 190 | 🐛 15 | 🌐 Java | 📅 2026-06-30 - Postman collection to JMeter jmx file converter.
...
* InfluxDB & Grafana
  * [InfluxDB Community Template for JMeter](https://github.com/influxdata/community-templates/tree/master/apache_jmeter) ⭐ 374 | 🐛 76 | 🌐 Python | 📅 2023-06-15 - Prepackaged InfluxDB configurations that contain everything from dashboards and Telegraf configurations to notifications and alerts in a single manifest file.
...
* ELK Stack
  * [jmeter-logstash](https://github.com/anasoid/jmeter-logstash) ⭐ 7 | 🐛 6 | 🌐 Shell | 📅 2026-08-20 - Parse JTL result with Docker and Logstash in real time or after test end, and send data to Elasticsearch or InfluxDB, to have a nice dashboard and compare different tests.
