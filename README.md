...
* [GitHub Repository](https://github.com/apache/jmeter) ⭐ 9,528 | 🐛 976 | 🌐 Java | 📅 2026-09-06 - Apache JMeter source code repository.
...
* [pymeter](https://github.com/eldaduzman/pymeter) ⭐ 134 | 🐛 6 | 🌐 Python | 📅 2023-12-05 - Simple JMeter performance tests API for Python.
* [jmeter-as-code](https://github.com/anasoid/jmeter-as-code) ⭐ 39 | 🐛 18 | 🌐 Java | 📅 2026-09-08 - Simple wrapper for JMeter to write and execute JMeter tests with Java.
...
* [loadtest](https://github.com/tmobile/loadtest) ⭐ 92 | 🐛 10 | 🌐 R | 📅 2020-05-06 - An R package for load testing using JMeter.

### Frameworks

* [MeterSphere](https://github.com/metersphere/metersphere) ⭐ 13,512 | 🐛 2 | 🌐 Java | 📅 2026-09-01 - One-stop open-source enterprise-class continuous testing platform, compatible with open-source standards such as JMeter :cn:.
...
* [postman2jmx](https://github.com/Loadium/postman2jmx) ⭐ 189 | 🐛 15 | 🌐 Java | 📅 2026-06-30 - Postman collection to JMeter jmx file converter.
* [swaggerjmx](https://github.com/Pactortester/swaggerjmx) ⭐ 115 | 🐛 1 | 🌐 Python | 📅 2026-06-23 - Tool to convert Swagger UI specification into JMeter test plans.
* [fiddler2jmeter](https://github.com/dperfly/fiddler2jmeter) ⭐ 51 | 🐛 0 | 🌐 Python | 📅 2025-07-15 - Fiddler or Charles to JMeter script convertor.
* [har-convertor-jmeter-tool](https://github.com/vdaburon/har-convertor-jmeter-plugin) ⭐ 25 | 🐛 2 | 🌐 Java | 📅 2026-02-24 - Apache JMeter Plugin to convert a HAR file to a JMeter script and Record XML file.
* [JMeter HAR Importer Plugin](https://github.com/Qytera-Gmbh/JMeterHARImporterPlugin) ⭐ 19 | 🐛 2 | 🌐 Java | 📅 2026-07-01 - JMeter plugin to import HTTP Archive (HAR) files into Apache JMeter.
* [convert-postman-jmeter](https://github.com/sercheo87/convert-postman-jmeter) ⭐ 14 | 🐛 3 | 🌐 JavaScript | 📅 2026-07-04 - Convert Postman projects to JMeter.
...
* Testing in Cloud
  ...
  * Amazon Web Services
    ...
    * [jmeter-ecs](https://github.com/smithmicro/jmeter-ecs) ⭐ 45 | 🐛 16 | 🌐 Shell | 📅 2022-11-22 - JMeter Docker image for distributed testing on EC2 Container Service (ECS).
...
* [JtlReporter](https://github.com/ludeknovy/jtl-reporter) ⭐ 151 | 🐛 2 | 🌐 Python | 📅 2026-04-11 - Online reporting application to generate reports by uploading JTL file.
...
* SLA and KPIs
  * [JMeter SLA Report](https://github.com/sgoeschl/jmeter-sla-report) ⭐ 38 | 🐛 1 | 🌐 HTML | 📅 2021-04-23 - JMeter HTML report generator based on JAMon.
...
* InfluxDB & Grafana
  * [InfluxDB Community Template for JMeter](https://github.com/influxdata/community-templates/tree/master/apache_jmeter) ⭐ 375 | 🐛 76 | 🌐 Python | 📅 2023-06-15 - Prepackaged InfluxDB configurations that contain everything from dashboards and Telegraf configurations to notifications and alerts in a single manifest file.
...
* ELK Stack
  * [jmeter-logstash](https://github.com/anasoid/jmeter-logstash) ⭐ 7 | 🐛 6 | 🌐 Shell | 📅 2026-09-03 - Parse JTL result with Docker and Logstash in real time or after test end, and send data to Elasticsearch or InfluxDB, to have a nice dashboard and compare different tests.
...
* Prometheus
  * [jmeter-prometheus-plugin](https://github.com/johrstrom/jmeter-prometheus-plugin) ⭐ 189 | 🐛 36 | 🌐 Java | 📅 2023-08-03 - A Prometheus Listener for Apache JMeter that exposes results in HTTP API.
...
* Backend Listener Implementations
  * [jmeter-influxdb2-listener-plugin](https://github.com/mderevyankoaqa/jmeter-influxdb2-listener-plugin) ⭐ 133 | 🐛 54 | 🌐 Java | 📅 2024-08-09 - InfluxDB v2.0 listener plugin for Apache JMeter.
  * [jmeter-elasticsearch-backend-listener](https://github.com/anthonygauthier/jmeter-elasticsearch-backend-listener) ⭐ 101 | 🐛 20 | 🌐 Java | 📅 2024-03-11 - JMeter plugin to send test results to an Elasticsearch engine.
  * [jmeter-backend-listener-kafka](https://github.com/veeranalyticsltd/jmeter-backend-listener-kafka) ⭐ 33 | 🐛 6 | 🌐 Java | 📅 2022-05-20 - JMeter plugin to send test results to a Kafka server.
  ...
  * [perfana-jmeter-timescaledb](https://github.com/perfana/perfana-jmeter-timescaledb) ⭐ 1 | 🐛 0 | 🌐 Java | 📅 2026-09-09 - JMeter backend listener plugin that writes test results directly to TimescaleDB for real-time performance analysis.
...
* [JMeter Viewer](https://github.com/anboralabs/intellij-jmeter) ⭐ 6 | 🐛 5 | 🌐 Java | 📅 2026-09-04 - Open JMeter test plans inside IntelliJ IDE.
...
* [Awesome Testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,370 | 🐛 14 | 📅 2026-09-04 - A curated list of testing resources.
